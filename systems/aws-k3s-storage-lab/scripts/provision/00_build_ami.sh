...
# ══════════════════════════════════════════════════════════════════
CURRENT_STEP="1/3"; CURRENT_TARGET="packer-local"; echo "[step=$CURRENT_STEP][target=$CURRENT_TARGET] Packer 사전 조건 점검"
echo " Region : $REGION"
echo " Key    : $KEY_NAME"
...
# ══════════════════════════════════════════════════════════════════
CURRENT_STEP="2/3"; CURRENT_TARGET="packer:frontend"; echo "[step=$CURRENT_STEP][target=$CURRENT_TARGET] Frontend AMI 빌드"
...
# ══════════════════════════════════════════════════════════════════
CURRENT_STEP="3/3"; CURRENT_TARGET="packer:backend"; echo "[step=$CURRENT_STEP][target=$CURRENT_TARGET] Backend AMI 빌드"
...
echo "    USE_PACKER_AMI=true bash scripts/lifecycle/start.sh"
